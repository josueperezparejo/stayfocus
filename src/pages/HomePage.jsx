...
import imageUser from '../assets/image.svg';
      ...
      <div className='container mx-auto'>
        <section className="bg-white dark:bg-gray-900">
          <div className="grid max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
            <div className="mr-auto place-self-center lg:col-span-7">
              <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Don't worry about <br /> the time</h1>
              <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">StayFocus is an app that has been carefully designed to help you manage your daily <span className='font-bold text-blue-500'>responsibilities</span> efficiently and effectively.</p>
              <Button onClick={onClick} radius="full" color='primary' className=" text-white shadow-lg">
                Try it for free!
              </Button>
            </div>
            <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
              <Image className='u--fadeInUp' src={imageUser} alt='fondo image' isBlurred />
            </div>
          </div>
        </section>
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-2 px-4 mx-auto max-w-screen-xl sm:py-4 lg:px-6">
            <div className="max-w-screen-lg mx-auto mb-8 lg:mb-14">
              <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white text-end">Designed for you</h2>
              <p className="text-gray-500 justify-items-end sm:text-xl dark:text-gray-400 text-end">StayFocus is designed with the key features you need <br /> to manage your time and achieve your <span className='font-bold text-blue-500'>goals</span> and desires effectively.</p>
            </div>
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
              <div className='rounded-lg p-3 border shadow-xl u--fadeInUp'>
                ...
                <h3 className="text-blue-500 mb-2 text-xl font-bold dark:text-white">Intuitive Interface</h3>
                <p className="text-gray-500 dark:text-gray-400">A user-friendly and easy-to-use interface that allows users to start working seamlessly.</p>
              </div>
              <div className='rounded-lg p-3 border shadow-xl u--fadeInUp'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="text-blue-500 mb-2 text-xl font-bold dark:text-white">Mobile Access</h3>
                <p className="text-gray-500 dark:text-gray-400">Access to the application from mobile devices to manage tasks on the go.</p>
              </div>
              <div className='rounded-lg p-3 border shadow-xl u--fadeInUp'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="text-blue-500 mb-2 text-xl font-bold dark:text-white">Task Management</h3>
                <p className="text-gray-500 dark:text-gray-400">Allows users to create, edit, and delete tasks easily.</p>
              </div>
              <div className='rounded-lg p-3 border shadow-xl u--fadeInUp'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="text-blue-500 mb-2 text-xl font-bold dark:text-white">Organization</h3>
                <p className="text-gray-500 dark:text-gray-400">Categorization and labeling of tasks for improved organization.</p>
              </div>
              <div className='rounded-lg p-3 border shadow-xl u--fadeInUp'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="text-blue-500 mb-2 text-xl font-bold dark:text-white">Free Versions</h3>
                <p className="text-gray-500 dark:text-gray-400">Offering a free version to help you get started with managing your productivity.</p>
              </div>
              <div className='rounded-lg p-3 border shadow-xl u--fadeInUp'>
                <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <h3 className="text-blue-500 mb-2 text-xl font-bold dark:text-white">Real-Time Synchronization</h3>
                <p className="text-gray-500 dark:text-gray-400">The ability to automatically synchronize data and changes in real time across all platforms and devices where the application is used.</p>
              </div>
            </div>
          </div>
        </section>
